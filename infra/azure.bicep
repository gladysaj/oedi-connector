  ...
  properties: {
    ...
    siteConfig: {
      appSettings: [
        ...
        {
          name: 'OPENEI_API_KEY'
          value: '@Microsoft.KeyVault(VaultName=${keyVault.name};SecretName=${keyVault::openEIApiKeySecret.name})'
        }
        {
          name: 'TEAMSFX_ENV'
          value: teamsfxEnv
...
resource keyVault 'Microsoft.KeyVault/vaults@2021-06-01-preview' = {
  ...
  resource openEIApiKeySecret 'secrets' = {
    name: 'OpenEIApiKey'
    properties: {
      contentType: 'text/plain'
      value: openEIApiKey
